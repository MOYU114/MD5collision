...
def collide(ihv):
    ...
    plus = '  > /dev/null 2>&1'
    os.system('.\\fastcoll --ihv {} -o {} {}'.format(ivhex, f0, f1))
...
class Collider:
    ...
    def my_get_collisions(self):
        program_good = self.alldata[0]+self.div[0][0]+self.alldata[1]
        program_evil = self.alldata[0]+self.div[0][1]+self.alldata[1]
